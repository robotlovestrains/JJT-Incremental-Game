...
addLayer("Island1", {
    ...
    gainMult() {
        ...
        if(hasUpgrade('Island3e', 15)) mult = mult.times(upgradeEffect('Island3e', 15))
        if(hasUpgrade('Island3e', 21)) mult = mult.times(8.2)
        if(hasUpgrade('Island3e', 22)) mult = mult.times(50)
        if(hasUpgrade('Island3e', 23)) mult = mult.times(22/7)
        if(hasUpgrade('Island3e', 24)) mult = mult.times(20)
        ...
        if(hasUpgrade('Research', 34)) mult = mult.times(10)
        if(hasUpgrade('Research', 45)) mult = mult.times(100)
        if(hasUpgrade('Research', 52)) mult = mult.times(10)
        if(hasUpgrade('Research', 61)) mult = mult.times(9.999)
        if(hasUpgrade('Research', 65)) mult = mult.times(9.999)
...
addLayer("Island2b", {
    ...
    gainMult() {
        ...
        if(hasUpgrade('Island3c', 23)) mult = mult.times(1.2)
        if(hasUpgrade('Island3e', 21)) mult = mult.times(4.1)
        if(hasUpgrade('Island3e', 23)) mult = mult.times(22/7)
        ...
        if(hasUpgrade('Research', 52)) mult = mult.times(10)
        if(hasUpgrade('Research', 55)) mult = mult.times(upgradeEffect('Island3e', 15))
        if(hasUpgrade('Research', 62)) mult = mult.times(9.999)
        if(hasUpgrade('Research', 65)) mult = mult.times(9.999)
    ...
    buyables: {
        11: {
            ...
            buy() {
                ...
                setBuyableAmount(this.layer, this.id, getBuyableAmount(this.layer, this.id).add(1))
                if(hasUpgrade('Research', 54) && this.canAfford()) this.buy()
            },
            unlocked() {return hasUpgrade(this.layer, 11)},
        },
    },
...
addLayer("Island3d", {
    ...
    getMonersGain() {
        ...
        if(hasUpgrade('Island2b', 25)) gain = gain.times(1.1)
        if(hasUpgrade('Island3a', 24)) gain = gain.times(1.5)
        if(hasUpgrade('Island3c', 23)) gain = gain.times(1.2)
        if(hasUpgrade('Island3e', 21)) gain = gain.times(2)
        if(hasUpgrade('Island3e', 23)) gain = gain.times(22/7)
        if(hasUpgrade('Research', 55)) gain = gain.times(upgradeEffect('Island3e', 15))
        ...
        if(hasUpgrade('Research', 52)) gain = gain.times(10)
        if(hasUpgrade('Research', 63)) gain = gain.times(9.999)
        if(hasUpgrade('Research', 65)) gain = gain.times(9.999)
    ...
    automate() {
        ...
        if(hasUpgrade('Research', 33)) {
            ...
            if(player["Island2b"].points.gte(new Decimal(1e9).times(new Decimal(5).pow(3)))) {
                player[this.layer].points = player[this.layer].points.add(layers[this.layer].getMonersGain().times(5));
            };
            if(player["Island2b"].points.gte(new Decimal(1e9).times(new Decimal(6).pow(3)))) {
                player[this.layer].points = player[this.layer].points.add(layers[this.layer].getMonersGain().times(6));
        ...
        if(hasUpgrade('Research', 41)) {
            ...
            if(player["Island2b"].points.gte(new Decimal(1e9).times(new Decimal(14).pow(3)))) {
                player[this.layer].points = player[this.layer].points.add(layers[this.layer].getMonersGain().times(14));
            };
            if(player["Island2b"].points.gte(new Decimal(1e9).times(new Decimal(15).pow(4)))) {
                player[this.layer].points = player[this.layer].points.add(layers[this.layer].getMonersGain().times(15));
            };
...
addLayer("Island3e", {
    ...
    upgrades: {
        ...
        15: {
            ...
            description() {
                let Text = ""
                Text = "Reasearch Boost Sub-Skill (Research + 1)^0.5 [x] [No Cap]"
                if(hasUpgrade('Research', 51)) Text = "Reasearch Boost Sub-Skill (Research + 1)^0.66 [x] [No Cap]"
                return Text
            },
            effect() {
                let Effect = new Decimal(1)

                Effect = Effect.times(player['Research'].points.add(1).pow(0.5))
                if(hasUpgrade('Research', 51)) Effect = new Decimal(1).times(player['Research'].points.add(1).pow(0.66))
        ...
        21: {
            title: "New XII #82",
            description: "x8.2 Sub-Skill and x4.1 Money, x2 Moners",
            currencyDisplayName: "Sub-Skill",
            currencyInternalName: "points",
            currencyLayer: "Island1",
        ...
        23: {
            title: "New XIV #84",
            description: "x22/7 Sub-Skill, Money, Moners",
            currencyDisplayName: "Sub-Skill",
            currencyInternalName: "points",
            currencyLayer: "Island1",
    ...
    upgrades: {
        11: {
            ...
            description() {
                ...
                if(hasUpgrade('Research', 45)) Text = "Total Upgrades in Island 1, 2, 3 and Total Research Upgrades and Total Upgrades in Island 3 area 4 again Boost Sub-Skill and Money and Moners (x^0.15 + 1) x 2.5 [x] [No Cap]"
                return Text
            },
            effect() {
                let Effect = new Decimal(1)
                ...
                if(hasUpgrade('Research', 45)) new Decimal(1).times(new Decimal(player[this.layer].upgrades.length).add(player[this.layer].upgrades.length).add(player["Island3e"].upgrades.length).add(player["Island3d"].upgrades.length).add(player["Island3c"].upgrades.length).add(player["Island3b"].upgrades.length).add(player["Island3a"].upgrades.length).add(player["Island2b"].upgrades.length).add(player["Island2a"].upgrades.length).add(player["Island1"].upgrades.length).add(player['Research'].upgrades.length).pow(0.15).add(1))
...
addLayer("Research", {
    ...
    gainMult() {
        ...
        if(hasUpgrade(this.layer, 64)) mult = mult.times(1.25)
    ...
    upgrades: {
        ...
        15: {
            title: "Restart V #55",
            description: "x5 Moners and Autobuy Upgrades #1 - #20",
            cost: new Decimal(1),
            unlocked() {return hasUpgrade(this.layer, 14)},
        },
        21: {
        ...
        22: {
            ...
            description: "Autobuy Upgrades #21 - #30",
            cost: new Decimal(2),
            unlocked() {return hasUpgrade(this.layer, 21)},
        },
        23: {
        ...
        25: {
            title: "Restart X #60",
            description: "Autobuy Upgrades #31 - #40",
            cost: new Decimal(2),
            unlocked() {return hasUpgrade(this.layer, 24)},
        },
        31: {
        ...
        34: {
            title: "Restart XI #77",
            description: "x3 Sub-Skill",
            cost: new Decimal(15),
            unlocked() {return hasUpgrade(this.layer, 33)},
        },
        35: {
            title: "Upgraded I #78",
            description: "#41 Applies to Research Upgrades",
            cost: new Decimal(15),
            unlocked() {return hasUpgrade(this.layer, 34)},
        },
        41: {
            title: "QoL II #79",
            description: "AutoGain The Next 5 Converters in Island 3 moners",
            cost: new Decimal(15),
            unlocked() {return hasUpgrade(this.layer, 35)},
        },
        42: {
            title: "More Content III #80",
            description: "Unlock More Upgrades In Island 3 area 3",
            cost: new Decimal(15),
            unlocked() {return hasUpgrade(this.layer, 41)},
        },
        43: {
            title: "More Auto II #87",
            description: "Autobuy Upgrades #41 - #50",
            cost: new Decimal(0),
            unlocked() {return hasUpgrade('Island3e', 25)},
        },
        44: {
            title: "More Auto III #88",
            description: "Autobuy Upgrades #63 - #75",
            cost: new Decimal(150),
            unlocked() {return hasUpgrade(this.layer, 43)},
        },
        45: {
            title: "Super Boost I #89",
            description: "x100 Sub-Skill",
            cost: new Decimal(150),
            unlocked() {return hasUpgrade(this.layer, 44)},
        },
        51: {
            title: "The Process I #90",
            description: "+0.16 Exponnent in Upgrade #81",
            cost: new Decimal(200),
            unlocked() {return hasUpgrade(this.layer, 45)},
        },
        52: {
            title: "The Process II #91",
            description: "x10 Sub-Skill, Money and Moners",
            cost: new Decimal(200),
            unlocked() {return hasUpgrade(this.layer, 51)},
        },
        53: {
            title: "The Process III #92",
            description: "Autobuy Upgrades #81 - #86",
            cost: new Decimal(200),
            unlocked() {return hasUpgrade(this.layer, 52)},
        },
        54: {
            title: "The Process IV #93",
            description: "Max Buy Island 3 area 1 Infinite Buyable I",
            cost: new Decimal(300),
            unlocked() {return hasUpgrade(this.layer, 53)},
        },
        55: {
            title: "The Process V #94",
            description: "Upgrade #81 Applies to Money and Moners",
            cost: new Decimal(300),
            unlocked() {return hasUpgrade(this.layer, 54)},
        },
        61: {
            title: "The Process VI #95",
            description: "x9.999 Sub-Skill",
            cost: new Decimal(500),
            unlocked() {return hasUpgrade(this.layer, 55)},
        },
        62: {
            title: "The Process VII #96",
            description: "x9.999 Money",
            cost: new Decimal(500),
            unlocked() {return hasUpgrade(this.layer, 61)},
        },
        63: {
            title: "The Process VIII #97",
            description: "x9.999 Moners",
            cost: new Decimal(500),
            unlocked() {return hasUpgrade(this.layer, 62)},
        },
        64: {
            title: "The Process IX #98",
            description: "x1.25 Research",
            cost: new Decimal(500),
            unlocked() {return hasUpgrade(this.layer, 63)},
        },
        65: {
            title: "The Process X #99",
            description: "x9.999 Sub-Skill, Money and Moners",
            cost: new Decimal(1e3),
            unlocked() {return hasUpgrade(this.layer, 64)},
        },
        71: {
            title: "Final II #100",
            description: "Unlock ??? (some Later Update Thing)",
